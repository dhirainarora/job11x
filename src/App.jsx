          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-6 shadow-md rounded-2xl">
              <CardContent>
                ...
                <p className="text-sm text-gray-600 mb-4">"To improve your chances for Data Scientist roles, add 2 projects with SQL+Pandas and quantify results."</p>
            ...
            <Card className="p-6 shadow-md rounded-2xl">
              <CardContent>
                ...
                <p className="text-sm text-gray-600 mb-4">Next mock: Behavioral + SQL questions. Duration: 25 mins</p>
      ...
      <section id="pricing" className="py-24 bg-gradient-to-r from-blue-100 to-blue-200 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
          ...
          <Card className="p-8 shadow-lg rounded-2xl border-2 border-blue-600 relative">
            <span className="absolute -top-3 right-3 bg-blue-600 text-white text-xs px-3 py-1 rounded-full">Most Popular</span>
            <h3 className="font-bold text-xl mb-3">Pro</h3>
            <p className="text-sm text-gray-600 mb-5">Unlimited resumes, AI mentor, quizzes, roadmaps, interviews</p>
          ...
          <Card className="p-8 shadow-lg rounded-2xl">
            ...
            <p className="text-sm text-gray-600 mb-5">All Pro features + live mentor sessions + priority support</p>
      ...
      <section id="faq" className="py-20 bg-white">
        ...
        <div className="max-w-4xl mx-auto space-y-6 px-6">
          <details className="p-4 border rounded-md">
            ...
            <p className="mt-2 text-gray-600">Yes, you can start with the Free plan and upgrade anytime.</p>
          </details>
          <details className="p-4 border rounded-md">
            <summary className="font-semibold">How is it different from Zety or Kickresume?</summary>
            <p className="mt-2 text-gray-600">Unlike others, CareerAI is a full career co-pilot: resume, cover letter, mentor, roadmaps, interviews, insights, and more in one platform.</p>
          </details>
          <details className="p-4 border rounded-md">
            <summary className="font-semibold">Will this really help me get a job?</summary>
            <p className="mt-2 text-gray-600">Yes – our AI tools are designed to make you stand out, and many users have already landed jobs at top companies.</p>
          </details>
        </div>
      </section>
